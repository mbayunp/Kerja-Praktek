...
from controlers.codecorr_assigment_controler import (
    add_assigment,
    retrieve_assigments,
    retrieve_assigment,
    delete_assigment,
...
from models.codecorr_assigment import (
    CodeCorrAssigmentSchema,
)

router = APIRouter()

@router.post("/", response_description="Assigment data added into the database")
async def add_assigment_data(assigment: CodeCorrAssigmentSchema = Body(...)):
